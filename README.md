...
Another challenge I faced in this project was making sure that IK wasn't hard-coding too many variables. This was probably the most challenging for me conceptually because I wanted my code to be flexible enough for others to be able to change the data and for my functions to continue to work as they are intended to- I found that to combat this challenge it was best for me to think conceptually about the big picture. To do this, I drew (on a piece of paper with arrows) waht exactly I wanted each function to be doing (in the big picture) and then later adding details to how I was going to accomplish this. Once I did this, I found all of the hard-coded values and asked myself what the number represented and was able to make the connection between variables much easier this way!
